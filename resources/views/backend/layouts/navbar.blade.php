    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                <!-- Dashboard -->
                <li class="menu-item">
                    <a href="{{url('back/dashboard')}}" class="menu-link">
...
{{--                <li class="menu-item active open">--}}
                <li class="menu-item  @if( Request::segment(2)=='category' or Request::segment(2)=='category_down' ) active open @endif">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="{{route('category.index')}}" class="menu-link">
                                <div data-i18n="Without menu">Up Category</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="layouts-without-navbar.html" class="menu-link">
                                <div data-i18n="Without navbar">Down  Category</div>
                            </a>
                        </li>
                ...
                <li class="menu-item @if( Request::segment(2)=='product' ) active open @endif">
                    <a href="{{route('product.index')}}" class="menu-link">
                        ...
                        <div data-i18n="Boxicons">Product</div>
                    </a>
                </li>

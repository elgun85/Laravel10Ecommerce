               ...
               <div class="col-md-6">
                   <div class="card shadow">
                       <div class="card-header bg-secondary  mb-3" s>
                           <h5 class="card-title text-white" >Add Color</h5>
                       </div>
                       <div class="card-body">
                           <form action="{{route('color.store')}}" method="post">
                               ...
                               <div class="form-group ">
                                   ...
                                   <input type="text" required name="name"  placeholder="Name color" class="form-control mt-3" value="{{old('name')}}">

                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                ...
                                <img class="img-fluid w-100 " style="height: 400px;width: 150px"  src="{{asset($product->productImages[0]->image)}}" alt="{{$product->name}}">
                                        <style>
                            ...
                            <div class="card-body border-left border-right text-left  p-0 pt-4 pb-3">
                                <h5 class="text-truncate mb-3 ml-3 text-info ">{{$product->brand}}</h5>
                                <span class="text-truncate ml-3 mb-3  ">{{$product->name}}</span>
